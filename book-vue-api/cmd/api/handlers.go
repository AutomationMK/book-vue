...
// DeleteUser deletes a user from the database from json post id
...
// LogUserOutAndSetInactive logs a user out and sets user to inactive
...
// ValidateToken checks if the request token is valid and returns true or false
